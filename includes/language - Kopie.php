<?php
	...
	************************************************************************/
	...
	$line[1] = array_map("htmlspecialchars_decode", array_map("htmlentities", array_map("trim", $line[1]), array_fill(0, count($line[1]), null), array_fill(0, count($line[1]), 'UTF-8')) );
	//$line[2] = array_map("htmlspecialchars_decode", array_map("htmlentities", array_map("trim", $line[2]), array_fill(0, count($line[2]), null), array_fill(0, count($line[2]), 'UTF-8')) );
	$line[3] = array_map("htmlspecialchars_decode", array_map("htmlentities", array_map("trim", $line[3]), array_fill(0, count($line[3]), null), array_fill(0, count($line[3]), 'UTF-8')) );
	$line[4] = array_map("htmlspecialchars_decode", array_map("htmlentities", array_map("trim", $line[4]), array_fill(0, count($line[4]), null), array_fill(0, count($line[4]), 'UTF-8')) );
